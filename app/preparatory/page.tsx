        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-12">
          <motion.div custom={0} variants={fadeUpVariants} initial="hidden" animate="visible" className="max-w-2xl">
            ...
            <p className="text-white/70 text-lg leading-relaxed">
              The Preparatory examinations are designed to help you assess your understanding of the course material
              before the final exams. These exams cover all five subjects of the 4th semester Data Analytics curriculum
              and provide valuable practice for the final assessment.
            </p>
          </motion.div>
        ...
        <motion.div custom={2} variants={fadeUpVariants} initial="hidden" animate="visible">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {subjects.map((subject, index) => (
              <Link
                key={index}
                href={`/preparatory/${subject.toLowerCase().replace(/\s+/g, "-")}`}
